            ...
            <div className="p-4 border shadow-xl bg-white/80 backdrop-blur-xl border-white/20 rounded-2xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <input
                        ...
                        className="px-3 py-2 text-sm font-medium transition-all border border-gray-200 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    />
                    <input
                    ...
                    <select
                        ...
                        className="px-3 py-2 text-sm font-medium transition-all border border-gray-200 appearance-none cursor-pointer bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        style={{
                ...
                <div className="grid grid-cols-3 gap-3 mt-4">
                    <select
                        ...
                        className="px-3 py-2 text-sm font-medium transition-all border border-gray-200 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                    >
                    ...
                    <input
                        ...
                        className="px-3 py-2 text-sm font-medium text-center transition-all border border-gray-200 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                    />
                </div>
                ...
                <select
                    ...
                    className="w-full px-3 py-2 mt-3 text-sm font-medium transition-all border border-purple-200 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
                    <option value="before">
            ...
            <div className="p-4 border shadow-xl bg-white/80 backdrop-blur-xl border-white/20 rounded-2xl">
                ...
                <div className="space-y-4">
                    <input
                        ...
                        className="w-full px-3 py-2 text-sm font-medium placeholder-gray-400 transition-all border border-gray-200 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                    <input
